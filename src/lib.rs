...
//!
//! I suggest to check [examples/help.txt], which generated this self-describing
//! syntax help document:
//!
...
//! ```
//!
//! The string wrapped in `<>`(like the `bg:blue,green,b` in above example) is
//! called a element, start with a tag list(comma separated), those tags add
//! styles to inner items.
//!
...
//! Windows Terminal.
//!
//! If you want write your own generator, please checkout documents of
//! [Generator] trait.
//!
...
/// Parse markup language source, then generate final output using the provided
/// generator.
///
/// See document of generator type for examples.
///
